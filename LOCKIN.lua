...
Credits.TextSize = 16
Credits.Text = 'LOCKIN' '..version..' by Payson Holmes'
...
Notification({Title='LOCKIN' '..version;Text='Cheat loaded successfully.';Icon='rbxassetid://2572157833';Duration=10;})
wait(.5)
Notification({Title='LOCKIN' '..version;Text='https://github.com/P-DennyGamingYT/';Icon='https://cdn-icons-png.flaticon.com/512/25/25231.png';Duration=10;})
wait(.5)
Notification({Title='Creator';Text='Payson Holmes';Duration=4;Icon='https://tr.rbxcdn.com/beda0f6f13922851e9fa19c1f53d6968/150/150/AvatarHeadshot/Png'})
wait(.5)
Notification({Title='Thank you!';Text='If you like this script, please consider subscribing to my YT @P-Denny';Duration=4;})
